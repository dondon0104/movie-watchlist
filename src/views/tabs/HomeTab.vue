<template>
  <ion-page><ion-header><ion-toolbar><ion-title>ScreenTime</ion-title><ion-button slot="end" fill="clear" @click="router.push('/tabs/profile')"><ion-icon slot="icon-only" :icon="personCircleOutline" /></ion-button></ion-toolbar></ion-header>
